...
type User = { id: string; email: string; subscription_tier: "free" | "pro" | "premium"; account_balance: number; referral_code?: string; bonus_trades?: number; referral_count?: number; discord_id?: string | null; discord_username?: string | null; daily_loss_limit?: number; weekly_digest_enabled?: boolean; discord_share_wins?: boolean; leaderboard_optin?: boolean };
type AuthCtx = {
  user: User | null;
  loading: boolean;
